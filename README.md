...
1. **Advanced OOP Architecture:** The system is built on a solid foundation of OOP pillars to ensure scalability and maintainability:
...
2. **Custom Library Development:** To master the internals of C++, I developed several custom utility libraries instead of relying solely on standard shortcuts:
...
Bash
git clone [https://github.com/mohamedelsawah345/Bank-Broject-Using-OOP.git](https://github.com/mohamedelsawah345/Bank-Broject-Using-OOP.git)
cd Bank-Broject-Using-OOP
Compile the project:

For Linux/macOS (using GCC/G++):

Bash
g++ -std=c++17 -o BankSystem main.cpp
For Windows (using Visual Studio / MSVC):
You can open the folder in Visual Studio or compile via the Developer Command Prompt:
